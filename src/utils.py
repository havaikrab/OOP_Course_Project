...
def currency_code_detector(currency_code: str) -> str:
    """Проверяет существование указанного кода валюты, если код не найден, возвращает RUB"""
